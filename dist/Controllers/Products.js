...
var ProductSearchController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, categoria, nombre_producto, pagina, tamaño_pagina, products, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, categoria = _a.categoria, nombre_producto = _a.nombre_producto, pagina = _a.pagina, tamaño_pagina = _a.tamaño_pagina;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
var ProductGetController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, pagina, tamaño_pagina, products, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, pagina = _a.pagina, tamaño_pagina = _a.tamaño_pagina;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, app_1.prisma.products.findMany({
